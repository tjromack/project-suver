...
> **Status — a multi-platform hub: 7 tools across 2 platforms on one shell.** **Platform #1 — Documents**
...
> — *who · what · by when* — grounded; cite-or-drop the action, owner/due only if stated). 93 tests (stub-backed,
